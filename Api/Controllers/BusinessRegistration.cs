...
namespace Api.Controllers
{
    ...
    public class BusinessRegistrationController : ControllerBase
    {
        ...
        public BusinessRegistrationController(AppDbContext context, Api.Services.IPasswordHasher passwordHasher, IConfiguration config, IHttpClientFactory httpClientFactory)
        {
            _context = context;
